...
It provides *basic* instructions for installing a *non-production* Jenkins instance on a number of platforms.
This Jenkins instance should be sufficient for learning and experimentation.
These instructions *DO NOT* cover the full range of considerations or options for installing Jenkins.
See link:/doc/book/appendix/advanced-installation/[Advanced Jenkins Installation]
====

== Overview
It is easy to install a basic Jenkins server on a wide range of platforms.
...
If you have a *non-production* Jenkins server already running on a system and want to upgrade, see
link:/doc/book/getting-started/upgrading/[Upgrading Jenkins].
If you are installing or upgrading a production Jenkins server, see
link:/doc/book/appendix/advanced-installation/[Advanced Jenkins Installation].
====
